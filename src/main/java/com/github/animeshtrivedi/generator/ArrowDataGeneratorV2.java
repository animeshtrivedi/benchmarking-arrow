...
abstract public class ArrowDataGeneratorV2 implements DataInterface {
    ...
    public ArrowDataGeneratorV2(WritableByteChannel channel){
        ...
        try {
            ...
            while (rowsToGenerate > 0) {
                ...
                for(int colIdx = 0; colIdx < columns; colIdx++){
                    ...
                    fillup(now, fv);
                    //This commits and make space visible in "binVector.getBufferSize()"
                    //System.err.println(" Binary buffer size is : " + binVector.getBufferSize() + " currentSize " + binVector.getCurrentSizeInBytes() + " capacity " + binVector.getValueCapacity());
                    //  Binary buffer size is : 1033 currentSize 0 capacity 8191
                    // Binary buffer size is : 2061 currentSize 0 capacity 8191
                    // Binary buffer size is : 3089 currentSize 0 capacity 8191
                ...
                this.recordIndex++;
                System.err.println(" looping with the record size of " + this.arrowFileWriter.getRecordBlocks().size());
                // decrease the count
                rowsToGenerate-=now;
            }
            // close the writer
